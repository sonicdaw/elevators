...
<?php } ?>
  ...
  function draw(){
    ...
    ctx.fillText("ENTAFLIP", LEFT_OFFSET + FIELD_WIDTH / 2, TOP_OFFSET + (TOP_OFFSET + FIELD_HEIGHT / 8));
    ctx.font = "17pt 'Times New Roman'";
    ctx.fillText("Copyright(C) 2026", LEFT_OFFSET + FIELD_WIDTH / 2, TOP_OFFSET + (TOP_OFFSET + FIELD_HEIGHT / 8 * 1.5));
    ctx.stroke();
